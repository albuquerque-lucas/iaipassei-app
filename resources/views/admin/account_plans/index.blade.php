...
@section('main-content')
    <section class='admin-account-plans-page container mt-5'>
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <a href="{{ route('admin.account_plans.create') }}" class="btn btn-primary me-2">Adicionar Plano</a>
        ...
        <x-dashboards.admin-account-plans-dashboard :data="$accountPlans" :editRoute="$editRoute" :deleteRoute="$deleteRoute" :paginationLinks="$paginationLinks" />
    </section>
