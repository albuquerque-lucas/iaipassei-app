        ...
        <tbody>
            @forelse ($filteredSubjects as $subject)
                <tr>
                    ...
                    <td>{{ $subject->title }}</td>
                    <td>
                        <button type="button" class="btn btn-sm btn-dark delete-btn" data-bs-toggle="modal" data-bs-target="#confirmDeleteSubjectModal{{ $subject->id }}" data-bs-toggle="tooltip" data-bs-placement="top" title="Excluir Matéria">
